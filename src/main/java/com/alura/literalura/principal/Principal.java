    ...
    public void buscarAutorPorNombre () {
        ...
        public void listarAutoresVivos () {
            System.out.println("""
                    ...
                    -----------------------------
                     """);
            System.out.println("Ingrese año para verificar autores:");
            try {
    ...
    private void buscarLibrosPorIdioma(String idioma) {
        ...
        public void ListarAutoresPorNacimiento () {
            ...
            try {
                ...
                System.out.println("Año invalido: " + e.getMessage());
            }
        }
        ...
        public void ListarAutoresPorFallecimiento () {
            System.out.println("""
                    ---------------------------------------------------------
                     Libro por año de fallecimiento de autor
                    ----------------------------------------------------------
                     """);
            System.out.println("Introduzca el año de fallecimiento :");
            try {
